import RegisteredCategories from "@/admin/screen/catalog/category/list/components/RegisteredCategories.tsx";
import { registeredCategoryListStyle } from "@/admin/screen/catalog/category/list/components/style/RegisteredCategoryList.css.ts";
