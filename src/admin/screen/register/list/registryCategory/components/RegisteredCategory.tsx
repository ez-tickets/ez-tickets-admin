import CategoryModal from "@/admin/screen/register/list/registryCategory/components/CategoryModal.tsx";
import { registeredCategoryStyle } from "@/admin/screen/register/list/registryCategory/components/style/RegisteredCategory.css.ts";
