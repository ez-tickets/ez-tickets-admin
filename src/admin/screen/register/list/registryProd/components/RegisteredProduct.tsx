import ProdEditModal from "@/admin/screen/register/list/registryProd/components/ProdEditModal.tsx";
import { registeredProductStyle } from "@/admin/screen/register/list/registryProd/components/style/RegisteredProduct.css.ts";
